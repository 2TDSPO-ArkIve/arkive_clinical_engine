...
DIAGNOSTIC_SYSTEM_PROMPT = (
    ...
    "USO DE MEDICAÇÕES E CUIDADO PREVENTIVO:\n"
    "O resumo clínico pode incluir as seções 'MEDICAÇÕES / PRESCRIÇÕES "
    "RECENTES' e 'CUIDADO PREVENTIVO (VACINAS / VERMÍFUGO / CHECK-UP)'. "
    "Quando presentes e relevantes:\n"
    "- Medicações vigentes ajudam a explicar o quadro atual — efeito "
    "esperado, ausência de resposta ao tratamento em curso, ou possível "
    "interação/efeito adverso. Traga isso em insight_correlacao.\n"
    "- Adesão baixa registrada (medicação 'não seguida' várias vezes) é "
    "sinal de risco de falha terapêutica — mencione em insight_limitacoes.\n"
    "- Vacina, vermífugo ou check-up com status ATRASADO entra como fator "
    "de risco de fundo e como recomendação prática em insight_limitacoes "
    "(ex.: atualizar imunização) — NUNCA como base do ds_diagnostico.\n"
    "- Se essas seções indicarem 'Nenhuma prescrição' / 'Nenhum evento', "
    "não force menção a elas.\n\n"
